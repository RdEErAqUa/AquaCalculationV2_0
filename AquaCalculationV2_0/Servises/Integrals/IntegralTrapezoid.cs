...
namespace AquaCalculationV2_0.Servises.Integrals
{
    class IntegralTrapezoid : IIntegral
    {
        ...
        public ICollection<XYDataModel> Function(ICollection<XYDataModel> data) => data;
        ...
        {
            String Protocol = $"Метод Трапеций: При шаге интегрирования - {step}, та интервале интегрирования  - {{{a},{b}}} интеграл - ";
